  ...
  return (
    <section ref={containerRef} id="features" className="section-padding bg-mesh">
      <div className="container-wide mx-auto">
        ...
        >
          <p className="tagline mb-4">Tính năng nổi bật</p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Mọi thứ bạn cần để{" "}
            <span className="text-gradient-flame">làm chủ bữa ăn</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Calo Track kết hợp sức mạnh AI với trải nghiệm chat quen thuộc, giúp
            bạn kiểm soát calo một cách tự nhiên nhất.
          </p>
        </motion.div>
