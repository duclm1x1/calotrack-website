...
export const Hero = () => {
  ...
  return <section ref={containerRef} id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-mesh">
      {/* Floating decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div className="absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl" style={{
        ...
        <motion.div className="absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl" style={{
        background: "hsl(var(--flame) / 0.06)"
      }} animate={{
        scale: [1.2, 1, 1.2],
        opacity: [0.4, 0.6, 0.4]
      }} transition={{
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          ease: "easeOut"
            ...
            duration: 0.6
              ...
              Gửi ảnh bữa ăn →{" "}
              <span className="text-gradient-brand mx-0">Track calo trong Zalo</span>
            </motion.h1>
          ...
          ease: "easeOut"
            ...
            <div className="relative">
              ...
              scale: logoScale
                ...
                repeat: Infinity,
                ease: "easeInOut"
              }} src="/lovable-uploads/6b546c25-6ed9-4455-bdbb-b930dbde57f1.png" />
              </motion.div>

              {/* Orbiting elements */}
              <motion.div className="absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2" animate={{
              rotate: 360
            }} transition={{
              duration: 30,
              repeat: Infinity,
              ...
              <motion.div className="absolute top-1/2 left-1/2 w-[80%] h-[80%] -translate-x-1/2 -translate-y-1/2" animate={{
              rotate: -360
            }} transition={{
              duration: 25,
              repeat: Infinity,
